...
public class UserEverydaySportSituation {
    ...
    public UserEverydaySportSituation(int userId, Date collectDate, int sumConsumeEnergy, List<UserSportHistory> userSportHistories) {
        this.userId = userId;
    ...
    public String toString() {
        return "UserEverydaySportSituation{" +
                "userId=" + userId +
